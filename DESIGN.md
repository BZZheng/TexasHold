...
- **显示偏好**：深色使用苔绿与黄铜金，浅色使用沙岩与鼠尾草；桌面端从右侧打开设置抽屉，移动端从底部打开，提供 12 / 14 / 16px 三档字号并只保存在当前设备。
...
- 牌局进行中，观战者只能查看主动允许观战的玩家手牌；本手一旦实际看过，玩家随后隐藏也不撤销该观战者的既有权限。神秘玩家始终隐藏，摊牌后由服务端公开其余未弃牌手牌。
